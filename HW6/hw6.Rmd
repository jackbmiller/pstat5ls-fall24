...
To avoid your work being overwritten, **rename** this file (`hw6.Rmd`). You could add your name to the file name (e.g., `hw6-profmiller.Rmd`).
...
The first step in analyzing data is to make a graphical display. Use the following chunk to create a histogram of the body temperatures (`bodyTemps$temp`). Be sure to add a title and axis label. (See slide 24 of Lab 6 if you need help making a histogram.)
